...
namespace PharmaCite_Pharmacy_Managment_System.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(pharmacyVaultContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("UserId,UserName,Pwd,Age,RegisteredDate")] Users users)
        {
            if (id != users.UserId)
            {
                return NotFound();
